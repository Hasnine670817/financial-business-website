...
const SolutionCard = ({card}) => {
    ...
    return (
        <div className='bg-[linear-gradient(180deg,_#FFFFFF_0%,_rgba(255,_255,_255,_0.52)_100%)] [box-shadow:22px_40px_40px_0px_#0000000D] backdrop-filter backdrop-blur-[17.399999618530273px] rounded-3xl md:rounded-[35px] p-7 md:p-10 max-w-[380px] 2xl:max-w-[420px] my-2 mx-auto md:mx-0'>
