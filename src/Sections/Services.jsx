            ...
            <div className='container-custom'>
                <div className='lg:flex flex-wrap'>
                    <div className='lg:w-2/5 text-center lg:text-start'>
                        <div>
                            <p data-aos="fade-up" className='text-sm xl:text-xl font-medium text-old-green flex items-center justify-center lg:justify-start gap-2.5'>
                                <span className='xl:w-5 w-3 xl:h-5 h-3 rounded-full bg-old-green'></span>
                                Services
                            </p>
                        </div>

                        <h2 data-aos="fade-up" className='text-2xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-[65px] font-light leading-[1.2] mt-8 text-center lg:text-start text-old-green'><b className='font-semibold text-black'>Diverse</b> & <b className='font-semibold text-black'>Seasoned</b> <br /> Capital Solutions</h2>
                        ...
                        <span data-aos="fade-up" className='block bg-[linear-gradient(270deg,_#F3F4F6_0%,_#262F2E_48%,_#F3F4F6_100%)] h-0.5 max-w-[70%] mx-auto lg:mx-0 mb-15 lg:mb-0'></span>
                    </div>
