...
const Insights = () => {
    ...
    return (
        <section className='relative z-10 pt-10 pb-25'>
            ...
            <div className='container-custom'>
                <div>
                    <h2 className='text-2xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-[65px] font-light leading-[1.2] mt-6 text-center text-old-green mb-20'>Energy Market <strong className='font-bold'>Insights</strong></h2>
                </div>

                <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 2xl:gap-14'>
                    {
                        (showAll ? financeCards : financeCards.slice(0, 6)).map(financeCard => <FinanceCard key={financeCard.id} card={financeCard}></FinanceCard>)
                    }
                </div>
